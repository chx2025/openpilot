...
if __name__ == '__main__':  # generating code
  ...
  from openpilot.sunnypilot.selfdrive.controls.lib.longitudinal_backends.tn_no_dec.c_generated_code_tn.acados_ocp_solver_pyx import AcadosOcpSolverCython
...
class LongitudinalMpc(LongitudinalMpcSP):
  def __init__(self, dt=DT_MDL):
    ...
    self.tuning = DEFAULT_TN_LONG_MPC_TUNING
    self.tuning_revision = 0
    self.reset()
