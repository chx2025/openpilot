...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    // Local-only device console. The token is generated on-device and never logged.
    {"DeviceConsoleEnabled", {PERSISTENT | BACKUP, BOOL, "0"}},
    {"DeviceConsoleToken", {PERSISTENT | DONT_LOG, STRING}},
    {"WebTerminalEnabled", {PERSISTENT | BACKUP, BOOL, "0"}},
    {"ExternalBuzzerEnabled", {PERSISTENT | BACKUP, BOOL, "0"}},
