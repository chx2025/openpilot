...
class SidebarSP:
  ...
  def _egpu_status_detail(self) -> str:
    device_state = ui_state.sm["deviceState"]
    speed = chestnut_usb_speed_mbps(device_state)
  ...
  def _handle_egpu_click(self, mouse_pos) -> bool:
    ...
    if status == "error" and error:
      ...
      message = f"{self._egpu_status_detail()}\n{tr('Safely eject the eGPU before unplugging it?')}"
