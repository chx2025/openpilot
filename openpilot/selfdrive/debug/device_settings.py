...
EXTRA_SETTINGS: tuple[dict[str, Any], ...] = (
  ...
  {"key": "TeslaWebDrivingVisualization", "widget": "toggle", "title": "浏览器行驶状态与 HW4 可视化", "category": "Developer", "group": "本地网页控制台", "offroad_only": True},
  {"key": "DeviceConsoleEnabled", "widget": "toggle", "title": "启用本地网页控制台", "category": "Developer", "group": "本地网页控制台", "offroad_only": True},
  {"key": "WebTerminalEnabled", "widget": "toggle", "title": "启用网页终端（高风险）", "category": "Developer", "group": "本地网页控制台", "offroad_only": True},
  {"key": "ExternalBuzzerEnabled", "widget": "toggle", "title": "启用 GPIO42 外接蜂鸣器", "category": "Developer", "group": "C3XL 硬件", "offroad_only": True},
  {"key": "CustomAlertSounds", "widget": "toggle", "title": "启用 C3XL 自定义提示音", "category": "Developer", "group": "C3XL 硬件", "offroad_only": True},
